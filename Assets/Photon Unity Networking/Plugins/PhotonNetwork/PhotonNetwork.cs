...
public static class PhotonNetwork
{
    ...
    /// </summary>
    /// 
    internal static void RPC_ToListOfPlayers(PhotonView view, string methodName, PhotonPlayer[] targetPlayers, bool encrpyt, params object[] parameters)
	{
		if (!VerifyCanUseNetwork())
		{
			return;
		...
		if (networkingPeer != null)
		{
			networkingPeer.RPC_ToListOfPlayers(view, methodName, targetPlayers, encrpyt, parameters);
		}
		else
		{
